...
<body marginwidth="0" marginheight="0">
	<div class="container">
		<div class="public-nav">您当前的位置：<a href="">菜品分类管理</a>&gt;<a href="">菜品分类列表</a></div>
		<div class="public-content">
			<div class="public-content-header">
				<h3>菜品信息</h3>
			</div>
			<form action="<?php echo U('Index/DeleteAll',array('table'=>'dishtype'));?>">
			<div class="public-content-cont">
				<table class="public-cont-table">
					...
					<?php if(is_array($select)): foreach($select as $key=>$s): ?><tr>
						...
						<td>
							<div class="table-fun">
								<a href="<?php echo U('Dishtype/dishtypemodify',array('id'=>$s['id'],'name'=>$s['name']));?>">修改</a>
