...
<body marginwidth="0" marginheight="0">
	<div class="container">
		<div class="public-nav">您当前的位置：<a href="">菜品类型管理</a>&gt;<a href="#">添加子菜品类型</a></div>
		<div class="public-content">
			<div class="public-content-header">
				<h3>添加子菜品类型</h3>
			</div>
			<div class="public-content-cont">
			<form action="<?php echo U('Dishtype/subAdd');?>" method="post" enctype="multipart/form-data">
				<div class="form-group" style="display:none;">
					<label for="">菜品类型id：</label>
					<input class="form-input-txt" type="text" name="dishtypeid" value="" />
				</div>
